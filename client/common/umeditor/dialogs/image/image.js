...
//                }
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            // set type=ajax, so weline upload php will return json data instead of iframe. By JiTing, 20140725.
        ...
        submit: function (callback) {
		    ...
		    // Modified by JiTing 20150821, innerHTML will contains HTML tags which cannot be parsed to JSON.
